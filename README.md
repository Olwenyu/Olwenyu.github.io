<div class="PortfolioTemplate1" style="width: 1440px; height: 4805px; position: relative; background: #FFD8D9">
    <div class="MainMenu" style="width: 970px; height: 467px; left: 335px; top: 0px; position: absolute">
      <div class="BackgroundImage" style="width: 970px; height: 467px; left: 0px; top: 0px; position: absolute; background: white"></div>
      <div class="IMOlwenyuAStudent" style="width: 500px; left: 60px; top: 93px; position: absolute"><span style="color: #2B2B2B; font-size: 48px; font-family: Inter; font-weight: 700; line-height: 59.33px; word-wrap: break-word">I’m Olwenyu<br/></span><span style="color: black; font-size: 48px; font-family: Inter; font-weight: 700; line-height: 59.33px; word-wrap: break-word">a </span><span style="color: #FFB400; font-size: 48px; font-family: Inter; font-weight: 700; line-height: 59.33px; word-wrap: break-word">Student</span><span style="color: #2B2B2B; font-size: 48px; font-family: Inter; font-weight: 700; line-height: 59.33px; word-wrap: break-word"> </span></div>
      ...
      <div class="LoremIpsumDolorSitAmetConsecteturAdipiscingElitEtVolutpatFeugiatPlaceratLobortisNatoqueRutrumSemperSedSuspendisseNuncLectus" style="width: 424px; height: 88px; left: 60px; top: 229px; position: absolute; color: #767676; font-size: 16px; font-family: Inter; font-weight: 400; text-transform: capitalize; line-height: 24px; word-wrap: break-word">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et, volutpat feugiat placerat lobortis. Natoque rutrum semper sed suspendisse nunc lectus.</div>
      ...
      <div class="ButtonHireMe" style="width: 154px; height: 51px; left: 60px; top: 342px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
        <div class="ButtonHireMe" style="flex-direction: column; justify-content: flex-start; align-items: flex-start; display: flex">
          <div class="ButtonHireMe" style="padding-left: 32px; padding-right: 32px; padding-top: 16px; padding-bottom: 16px; background: #FFB400; border-radius: 5px; flex-direction: column; justify-content: center; align-items: center; gap: 10px; display: flex">
            <div class="Group74" style="position: relative">
              ...
              <div class="Frame" style="width: 16px; height: 16px; left: 74px; top: 1px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
                <div class="Vector" style="width: 16px; height: 16px"></div>
                <div class="Vector" style="width: 10.67px; height: 10.37px; background: #2B2B2B"></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="LeftMenu" style="width: 305px; height: 1315px; left: 0px; top: 0px; position: absolute">
      <div class="Rectangle1" style="width: 305px; height: 1315px; left: 0px; top: 0px; position: absolute; background: white"></div>
      <div class="Profile" style="width: 229px; height: 311px; left: 31px; top: 18px; position: absolute">
        <img class="Profile" style="width: 229px; height: 229px; left: 0px; top: 0px; position: absolute" src="https://via.placeholder.com/229x229" />
        <div class="Olwenyu" style="left: 77px; top: 213px; position: absolute; color: #2B2B2B; font-size: 18px; font-family: Inter; font-weight: 500; text-transform: capitalize; line-height: 22.25px; word-wrap: break-word">Olwenyu</div>
      ...
      <div class="About" style="width: 248px; height: 130px; left: 26px; top: 377px; position: absolute">
        ...
        <div class="Address" style="width: 248px; height: 24.76px; left: 0px; top: 105.24px; position: absolute">
          ...
          <div class="Address" style="width: 71.02px; height: 24.76px; left: 5.64px; top: -0px; position: absolute; color: #2B2B2B; font-size: 15px; font-family: Inter; font-weight: 400; text-transform: capitalize; line-height: 24px; word-wrap: break-word">Address:</div>
      ...
      <div class="Skills" style="width: 251px; height: 242px; left: 22px; top: 719px; position: absolute">
        ...
        <div class="Line" style="width: 251px; height: 4px; left: 0px; top: 66px; position: absolute">
          <div class="Rectangle12" style="width: 251px; height: 4px; left: 0px; top: 0px; position: absolute; border-radius: 30px; border: 0.50px #FFB400 solid"></div>
      ...
      <div class="ExtraSkills" style="width: 251px; height: 147px; left: 22px; top: 1012px; position: absolute">
        ...
        <div class="GulpWebpackGrunt" style="width: 251px; height: 23.84px; left: 0px; top: 94.36px; position: absolute">
      ...
      <div class="ButtonCv2" style="width: 220px; height: 40px; left: 41px; top: 1209px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
        <div class="ButtonCv2" style="width: 220px; height: 40px; justify-content: center; align-items: center; display: inline-flex">
          <div class="ButtonCv" style="width: 220px; height: 40px; position: relative; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: flex">
    ...
    <div class="ContactInformation" style="left: 437px; top: 4377px; position: absolute">
      ...
      <div class="Frame75" style="width: 758px; height: 210px; left: 0px; top: 100px; position: absolute; justify-content: flex-start; align-items: flex-start; gap: 18px; display: inline-flex">
        <div class="Location" style="width: 370px; height: 210px; position: relative">
          ...
          <div class="District6" style="left: 280px; top: 171px; position: absolute; text-align: right; color: #767676; font-size: 15px; font-family: Inter; font-weight: 400; text-transform: capitalize; line-height: 24px; word-wrap: break-word">District 6</div>
          ...
          <div class="ConsLocation" style="width: 18px; height: 18px; left: 176px; top: 36px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
            <div class="ConsLocation" style="width: 18px; height: 18px; justify-content: center; align-items: center; display: inline-flex">
              <div class="IconsLocation" style="width: 18px; height: 18px; position: relative; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: flex">
                <div class="Vector" style="width: 18px; height: 18px"></div>
                <div class="Vector" style="width: 15px; height: 15px; background: #2B2B2B"></div>
              </div>
            </div>
          </div>
        </div>
        <div class="Gmail" style="width: 370px; height: 210px; position: relative">
          ...
          <div class="Hoangvan748GmailCom" style="left: 154px; top: 99px; position: absolute; text-align: right; color: #767676; font-size: 15px; font-family: Inter; font-weight: 400; text-transform: capitalize; line-height: 24px; word-wrap: break-word">hoangvan748@gmail.com</div>
          ...
          <div class="Olwenyu" style="left: 269px; top: 137px; position: absolute; text-align: right; color: #767676; font-size: 15px; font-family: Inter; font-weight: 400; text-transform: capitalize; line-height: 24px; word-wrap: break-word">@Olwenyu</div>
          ...
          <div class="Olwenyu" style="left: 269px; top: 175px; position: absolute; text-align: right; color: #767676; font-size: 15px; font-family: Inter; font-weight: 400; text-transform: capitalize; line-height: 24px; word-wrap: break-word">@Olwenyu</div>
          ...
          <div class="ConsMail" style="width: 18px; height: 18px; left: 176px; top: 36px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
            <div class="ConsMail" style="width: 18px; height: 18px; justify-content: center; align-items: center; display: inline-flex">
              <div class="IconsMail" style="width: 18px; height: 18px; position: relative; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: flex">
                <div class="Vector" style="width: 18px; height: 18px"></div>
                <div class="Vector" style="width: 15px; height: 13.50px; background: #2B2B2B"></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="Fotter" style="width: 1440px; height: 60px; left: 0px; top: 4745px; position: absolute">
      ...
      <div class="Copyright" style="width: 272px; height: 24px; left: 0px; top: 18px; position: absolute">
        <div class="OlwenyuStudent" style="width: 213px; left: 59px; top: 0px; position: absolute; color: #2B2B2B; font-size: 15px; font-family: Inter; font-weight: 400; text-transform: capitalize; line-height: 24px; word-wrap: break-word">2024 - Olwenyu @Student</div>
        <div class="IconsCopyright" style="width: 35.63px; height: 24px; left: 0px; top: 0px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
          <div class="IconsCopyright" style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex">
            <div class="IconsCopyright" style="width: 35.63px; height: 24px; position: relative; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: flex">
              <div class="Vector" style="width: 35.63px; height: 24px"></div>
              <div class="Vector" style="width: 29.69px; height: 20px; background: white"></div>
            </div>
          </div>
        </div>
      </div>
